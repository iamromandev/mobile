...
public class PlayGame {
    ...
    public static final long MOVE_ANIMATION_TIME = PlayView.BASE_ANIMATION_TIME;
    public static final long SPAWN_ANIMATION_TIME = PlayView.BASE_ANIMATION_TIME;
    public static final long NOTIFICATION_ANIMATION_TIME = PlayView.BASE_ANIMATION_TIME * 5;
    ...
    public PlayGame(Context context, PlayView view) {
        mContext = context;
        mView = view;
        initSoundPool();
    }
