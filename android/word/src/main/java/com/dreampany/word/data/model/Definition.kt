...
@Entity(
    ...
    foreignKeys = [
        ...
        ForeignKey(
            ...
            parentColumns = [Constant.Keys.ID],
            childColumns = [Constants.Keys.Room.PART_OF_SPEECH_ID],
            onDelete = ForeignKey.NO_ACTION
        ),
        ForeignKey(
            entity = Word::class,
...
data class Definition(
    ...
    @ColumnInfo(name = Constants.Keys.Room.PART_OF_SPEECH_ID)
    var partOfSpeechId: String = Constant.Default.STRING,
    @ColumnInfo(name = Constants.Keys.Room.WORD_ID)
    var wordId: String = Constant.Default.STRING,
    var definition: String = Constant.Default.STRING,
    ...
    override fun toString(): String = "Definition: [definition:$definition]"
}